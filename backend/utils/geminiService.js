...
export const generateSummary = async (text) => {
  const prompt = `Provide a concise summary of the following text, highlighting the key concepts and main ideas, and important points.
...
export const chatWithContext = async (question, chunks) => {
  ...
  const prompt = `Based on the following context from a document, analyse the context and answer the user's questions. If the answer is not present in the context, say so.
