...
const LoginPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-500">
      ...
      <div className="absolute inset-0 bg-[radical-gradient(#e5e7eb_1px)] bg-size-[16px_16px] opacity-300" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onBlur={() => setFocusedField(null)}
                      className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate 50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-200 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10"
                      placeholder="********"
                      />
                    </div>
                </div>
